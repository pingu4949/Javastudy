...
public class Ex02 {
	public static void main(String[] args) {
		...
		// 				데이터는 같은 자료형이어야 한다. (프로모션 가능 : 작은자료형이 큰자료형에게 변경)
		
			
		su[0] = 100;
		su[1] = 'a'; // 프로모션 char형이 int형으로 들어감
		su[2] = (int)3.14; // 디모션 강제로 형변환 
		su[3] = 100;
		
		su[2] = 107; //기존 값이 사라지고 최신 값이 나온다.
	//  배열 크기보다 크면
	//	su[4] = 107; 실행하면 오류 발생(run time 오류)
